...
QUOTES = [
   ...
   # #  "Period. We can passionately protest without being violent.\""),
    ...
    #  "Americans across the country.\""),
     ("In January 2021, many Republicans and then-U.S. "
      "President Donald Trump supporters rioted and stormed "
      "the US Capitol. Senate Minority Leader Mitch McConnell "
      "(Republican) said the following about divisions in the country: "
      "\"January 6th was a disgrace. American citizens attacked their own "
      "government. They used terrorism to try to stop a specific piece "
      "of domestic business they did not like. Fellow Americans "
      "beat and bloodied our own police. They stormed the Senate floor. "
      "They tried to hunt down the Speaker of the House. They built a "
      "gallows and chatted about murdering the "
      "vice president. It was a disgrace.\""),
    #("In 2020, the popular Black Lives Matter social "
    # "movement burst into political violence on several "
...
def run_experiment(republican_csv_fname,
                   ...
                   context_fn,
                   treatment,
                   respondent_context_fn=lambda: None,
                   dry_run=False):
...
def run_mixed_affect_experiment(republican_csv_fname,
    ...
    reflection_prompt = ("The other day, I read that \"When "
                         "reading messages about political "
                         "opponents, many people feel mixed "
                         "emotions because the messages often "
                         "challenge some beliefs while affirming "
                         "others. Important research from psychology "
                         "shows that when people feel such mixed emotions, "
                         "their unconscious reaction is often to resolve "
                         "their discomfort by doubling down on their "
                         "initial beliefs even more and becoming less "
                         "open to opposing perspectives. But research "
                         "also shows that simply being mindful of these "
                         "mixed reactions can change us, allowing us to "
                         "focus on what we have in common and find ways "
                         "to work together, even across lines of "
                         "difference.\n\n"
                         "Please briefly describe a time "
                         "when you felt mixed emotion in response to a "
                         "message about political opponents, but "
                         "consciously resolved those feelings by "
                         "focusing on what you have in "
                         "common with those people:\"\n\n"
                         "In my response, I wrote that these thoughts")

    mixed_affect_reflection = partial(get_gpt_reflection,
                                      prompt=reflection_prompt,
                                      processor=PromptProcessor("davinci"))
    ...
    run_experiment(republican_csv_fname,
                   ...
                   context_fn=lambda: [None],
                   respondent_context_fn=mixed_affect_reflection,
                   dry_run=dry_run)


def run_composite_experiment(republican_csv_fname,
                             democrat_csv_fname,
                             engine,
                             dry_run=False):

    reflection_prompt = ("I also read that \"When "
                         "reading messages about political "
                         "opponents, many people feel mixed "
                         "emotions because the messages often "
                         "challenge some beliefs while affirming "
    ...
    run_experiment(republican_csv_fname,
                   ...
                   engine,
                   treatment="composite",
                   context_fn=lambda: [f"The other day I read that \"{q}\""
                                       for q in QUOTES],
                   respondent_context_fn=mixed_affect_reflection,
                   dry_run=dry_run)
