        ...
        templates = {
            ...
            '1_shot_copa' : (
                lambda row : (  SHOTS[4] + "Solve the following COPA task.\n\n"
                                ...
                                f"Choice 2. {row['choice2']}\nAnswer: Choice"), self.token_set_dict),
#-----------------------------------------UNTESTED YET--------------------------------------------------------
            'what_is_cause/effect_of_premise' : (
            ...
            'what_is_cause/effect_of_premise_given_smthn' : (
            ...
            'what_is_cause/effect_of_premise_given1or2' : (
            ...
            'Introducing_questions_then_premise_1' : (
                ...
                lambda row : (  f'If asked to pick between '
                                f'choice 1:"{row.choice1}" or '
                                f'choice 2:"{row.choice2}" to see what {row.question}d the premise:"{row.premise}"\n'
                                f'I would say:"choice'), self.token_set_dict
                            ),

            'Introducing_questions_then_premise_2' : (

                lambda row : (  f'If asked to choose between '
                                f'1:"{row.choice1}" or '
                                f'2:"{row.choice2}" to see what {row.question}d the premise:"{row.premise}"\n'
                                f'I would say:"'), self.token_set_dict
                            ),
            
            'I_want_to_figure_out' : (

                lambda row : (  f'I want to figure out what {row.question}d the premise:"{row.premise}"\n'
                                f'Choice 1:"{row.choice1}" or '
                                f'choice 2:"{row.choice2}"\n'
                                f'I would say:"choice'), self.token_set_dict
                            ),
            ...
            'NoChoices' : (
                ...
                lambda row : (  f'What {row.question}d the Premise:"{row.premise}"\n'
                                f'1:"{row.choice1}"\n'
                                f'2:"{row.choice2}"\n'
                                f'My answer would be:"'), self.token_set_dict
                            ),
