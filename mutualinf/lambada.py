...
class LambadaDataset(Dataset):
    ...
    def _modify_raw_data(self, df):
        # make column "story_with_mask" which is column "text" + ___.
        breakpoint()
        df['story_with_mask'] = df['text'] + ' ___.'
        return df
    ...
    def _get_templates(self):
        ...
        templates = {
            ...
            'story_d2' : (lambda row: (f"It was a cold night. The wind was ___ around the courtyard as I stepped out of the car and into the darkness.\nWord: whistling\n\n{row['story_with_mask']} \n"
            ...
            'repeat1': (lambda row: (f"Fill in the blank for the following sentences.\n\n"
                "\"It was a cold night. The wind was whistling around the courtyard as I stepped out of the car and into the ___.\" -> \"It was a cold night. The wind was whistling around the courtyard as I stepped out of the car and into the darkness.\"\n"
                f"\"{row['story_with_mask']}\" -> "
            ...
            'dialogue1' : (lambda row: (
                ...
                f"It was a cold night. The wind was ___ around the courtyard as I stepped out of the car and into the darkness."
                "\nP2: whistling"
                "\nP1: I'm going to tell you a story, but leave a word out. Once I'm done telling the story, pick the word that best fits in the blank. \n"
                f"{row['story_with_mask']} \nP2:"
                ), self.token_set_dict),
            ...
            'dialogue3' : (lambda row: (
                "P1: I'm going to tell you a story, but leave a word out. Once I'm done telling the story, pick the word that best fits in the blank. \n"
                f"I like to eat peanut butter and jelly ___."
                "\nP2: sandwiches"
                "\nP1: I'm going to tell you a story, but leave a word out. Once I'm done telling the story, pick the word that best fits in the blank. \n"
                f"{row['story_with_mask']} \nP2:"
                ), self.token_set_dict),
            ...
            'openai-2shot': (lambda row: (
                'Fill in blank:\n\n'
                'Alice was friends with Bob. Alice went to visit her friend ___. -> Bob\n'
                'George bought some baseball equipment, a ball, a glove, and a ___. -> bat\n'
                f'{row["story_with_mask"]} ->'
            ), self.token_set_dict),
