...
output = templatizer.templatize(n_per_category=4, n_exemplars=3, seed_instances=1, seed_exemplars=1, **prompts[version])
...
pklpath = os.path.join(exp_dir,f'output5.pickle')
