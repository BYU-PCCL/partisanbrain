...
class AnesFactory(DatasetFactory):
    ...
    def get_templates(self):
        # add token sets as dicts see example (map Kept the same to keep, kept, etc)
        return {
            "protecting_environment_spending" : {
                "finish_sentence" : (lambda row: (f"{make_backstory1(row)}\n\n"
                                                f"When asked federal spending on protecting the environment should be increased, decreased or stay the same,\n\n"
                ...
                "implicit_instructions" : (lambda row: (f"P1: {make_backstory1(row)}\n"
                                                        f"P2: When asked federal spending on protecting the environment should be increased, decreased or stay the same,\n"
