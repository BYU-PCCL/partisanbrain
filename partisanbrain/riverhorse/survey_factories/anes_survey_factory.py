    ...
    def get_templates(self):
        ...
        return {
            "protecting_environment_spending" : {
                ...
                "enumerated_response" : (lambda row: (f"{make_backstory1(row)} Between increased, decreased, or stay the same, federal spending on protecting the environment should be"), protecting_environment_spending_dict),
                
                "non_enumerated_response" : (lambda row: (f"{make_backstory1(row)} Federal spending on protecting the environment should be"), protecting_environment_spending_dict),

                "0_shot_first_person_backstory" : (lambda row: (f"{make_backstory1(row)} I think federal spending on protecting the environment should be"), protecting_environment_spending_dict),

                "1_shot_first_person_backstory" : (lambda row: (f"{make_backstory1_shot()} I think environmental protection is important.\n\n"
                                                                f"{make_backstory1(row)} I think federal spending on protecting the environment should be"), protecting_environment_spending_dict),
            ...
            "rising_temp_action" : {
                ...
                "enumerated_response" : (lambda row: (f"{make_backstory1(row)} Between more, less, or the same, regarding rising temperatures the federal government should be doing"), rising_temp_action_dict),
                
                "non_enumerated_response" : (lambda row: (f"{make_backstory1(row)} Regarding rising temperatures the federal government should be doing"), rising_temp_action_dict),

                "0_shot_first_person_backstory" : (lambda row: (f"{make_backstory1(row)} Regarding rising temperatures, I think the federal government should be doing"), rising_temp_action_dict),

                "1_shot_first_person_backstory" : (lambda row: (f"{make_backstory1_shot()} I think global warming is an important issue.\n\n"
                                                                f"{make_backstory1(row)} Regarding rising temperatures, I think the federal government should be doing"), rising_temp_action_dict),
            ...
            "dealing_with_crime_spending" : {
                ...
                "enumerated_response" : (lambda row: (f"{make_backstory1(row)} Between increased, decreased, or stay the same, federal spending on dealing with crime should be"), dealing_with_crime_dict),
                
                "non_enumerated_response" : (lambda row: (f"{make_backstory1(row)} Federal spending on dealing with crime should be"), dealing_with_crime_dict),

                "0_shot_first_person_backstory" : (lambda row: (f"{make_backstory1(row)} I think federal spending on dealing with crime should be"), dealing_with_crime_dict),

                "1_shot_first_person_backstory" : (lambda row: (f"{make_backstory1_shot()} I think public safety is important.\n\n"
                                                                f"{make_backstory1(row)} I think federal spending on dealing with crime should be"), dealing_with_crime_dict),
            ...
            "trump_handling_economy" : {
                ...
                "enumerated_response" : (lambda row: (f"{make_backstory1(row)} Regarding the way Donald Trump is handling the economy, between approve or disapprove, I"), trump_handling_economy_dict),
                
                "non_enumerated_response" : (lambda row: (f"{make_backstory1(row)} If someone asked me \"Do you approve or disapprove of the way Donald Trump is handling the economy?\", I would say \"I"), trump_handling_economy_dict),

                "0_shot_first_person_backstory" : (lambda row: (f"{make_backstory1(row)} My friend asked if I approve or disapprove of the way Donald Trump is handling the economy, I said I"), trump_handling_economy_dict),

                "1_shot_first_person_backstory" : (lambda row: (f"{make_backstory1_shot()} I think sandwiches are good.\n\n"
                                                                f"{make_backstory1(row)} My friend asked if I approve or disapprove of the way Donald Trump is handling the economy, I said I"), trump_handling_economy_dict),
            ...
            "govt_waste_money" : {
                ...
                "enumerated_response" : (lambda row: (f"{make_backstory1(row)} Between a lot, some, or none, people in government waste"), govt_waste_money_dict),
                
                "non_enumerated_response" : (lambda row: (f"{make_backstory1(row)} Regarding tax money, people in government waste"), govt_waste_money_dict),

                "0_shot_first_person_backstory" : (lambda row: (f"{make_backstory1(row)} Regarding tax money, I think people in government waste"), govt_waste_money_dict),

                "1_shot_first_person_backstory" : (lambda row: (f"{make_backstory1_shot()} I think sandwiches are good.\n\n"
                                                                f"{make_backstory1(row)} Regarding tax money, I think people in government waste"), govt_waste_money_dict),
            ...
            "social_security_spending" : {
                ...
                "implicit_instructions" : (lambda row: (f"P1: {make_backstory1(row)}\n"
                                                        ...
                                                        f"P1: I think it should be"), dealing_with_crime_dict),
                "enumerated_response" : (lambda row: (f"{make_backstory1(row)} Between increased, decreased, or stay the same, federal spending on Social Security should be"), dealing_with_crime_dict),
                
                "non_enumerated_response" : (lambda row: (f"{make_backstory1(row)} Federal spending on Social Security should be"), dealing_with_crime_dict),

                "0_shot_first_person_backstory" : (lambda row: (f"{make_backstory1(row)} I think federal spending on Social Security should be"), dealing_with_crime_dict),

                "1_shot_first_person_backstory" : (lambda row: (f"{make_backstory1_shot()} I think sandwiches are good.\n\n"
                                                                f"{make_backstory1(row)} I think federal spending on Social Security should be"), dealing_with_crime_dict),
            ...
            "aid_poor_spending" : {
                ...
                "implicit_instructions" : (lambda row: (f"P1: {make_backstory1(row)}\n"
                                                        ...
                                                        f"P1: I think it should be"), dealing_with_crime_dict),
                "enumerated_response" : (lambda row: (f"{make_backstory1(row)} Between increased, decreased, or stay the same, federal spending on aid to the poor should be"), dealing_with_crime_dict),
                
                "non_enumerated_response" : (lambda row: (f"{make_backstory1(row)} Federal spending on aid to the poor should be"), dealing_with_crime_dict),

                "0_shot_first_person_backstory" : (lambda row: (f"{make_backstory1(row)} I think federal spending on aid to the poor should be"), dealing_with_crime_dict),

                "1_shot_first_person_backstory" : (lambda row: (f"{make_backstory1_shot()} I think sandwiches are good.\n\n"
                                                                f"{make_backstory1(row)} I think federal spending on aid to the poor should be"), dealing_with_crime_dict),
            ...
            "state_of_economy" : {
                ...
                "enumerated_response" : (lambda row: (f"{make_backstory1(row)} Between very good, good, neither good nor bad, bad or very bad, the United States economy is"), dealing_with_crime_dict),
                
                "non_enumerated_response" : (lambda row: (f"{make_backstory1(row)} The United States economy these days is"), dealing_with_crime_dict),

                "0_shot_first_person_backstory" : (lambda row: (f"{make_backstory1(row)} I think the United States economy these days is"), dealing_with_crime_dict),

                "1_shot_first_person_backstory" : (lambda row: (f"{make_backstory1_shot()} I think sandwiches are good.\n\n"
                                                                f"{make_backstory1(row)} I think the United States economy these days is"), dealing_with_crime_dict),
            ...
            "economy_change" : {
                ...
                "enumerated_response" : (lambda row: (f"{make_backstory1(row)} Between gotten better, gotten worse, or stayed the same, over the past year the nation\'s economy has"), dealing_with_crime_dict),
                
                "non_enumerated_response" : (lambda row: (f"{make_backstory1(row)} Over the past year the nation\'s economy has gotten"), dealing_with_crime_dict),

                "0_shot_first_person_backstory" : (lambda row: (f"{make_backstory1(row)} I think over the past year the nation\'s economy has gotten"), dealing_with_crime_dict),

                "1_shot_first_person_backstory" : (lambda row: (f"{make_backstory1_shot()} I think sandwiches are good.\n\n"
                                                                f"{make_backstory1(row)} I think over the past year the nation\'s economy has gotten"), dealing_with_crime_dict),
            ...
            "worry_financial_situation" : {
                ...
                "enumerated_response" : (lambda row: (f"{make_backstory1(row)} Regarding my family's financial situation, between extremely worried, very worried, moderately worried, a little worried, or not at all worried, I am"), dealing_with_crime_dict),
                
                "non_enumerated_response" : (lambda row: (f"{make_backstory1(row)} Regarding my family's financial situation, I am"), worried_financial_situation_dict),

                "0_shot_first_person_backstory" : (lambda row: (f"{make_backstory1(row)} Regarding my family's financial situation, I think I am"), worried_financial_situation_dict),

                "1_shot_first_person_backstory" : (lambda row: (f"{make_backstory1_shot()} I think sandwiches are good.\n\n"
                                                                f"{make_backstory1(row)} Regarding my family's financial situation, I think I am"), worried_financial_situation_dict),
            ...
            "welfare_spending" : {
                ...
                "implicit_instructions" : (lambda row: (f"P1: {make_backstory1(row)}\n"
                                                        ...
                                                        f"P1: I think it should be"), dealing_with_crime_dict),
                "enumerated_response" : (lambda row: (f"{make_backstory1(row)} Between increased, decreased, or stay the same, federal spending on welfare programs should be"), dealing_with_crime_dict),
                
                "non_enumerated_response" : (lambda row: (f"{make_backstory1(row)} Federal spending on welfare programs should be"), dealing_with_crime_dict),

                "0_shot_first_person_backstory" : (lambda row: (f"{make_backstory1(row)} I think federal spending on welfare programs should be"), dealing_with_crime_dict),

                "1_shot_first_person_backstory" : (lambda row: (f"{make_backstory1_shot()} I think sandwiches are good.\n\n"
                                                                f"{make_backstory1(row)} I think federal spending on welfare programs should be"), dealing_with_crime_dict),
            ...
            "gender_view" : {
                ...
                "enumerated_response" : (lambda row: (f"{make_backstory1(row)} Between fully, somewhat, or not legally recognized, gay couple relationships should be"), gender_view_dict),
                
                "non_enumerated_response" : (lambda row: (f"{make_backstory1(row)} Regarding legal recognition, gay couple relationships should be"), gender_view_dict),

                "0_shot_first_person_backstory" : (lambda row: (f"{make_backstory1(row)} Regarding legal recognition, I think gay couple relationships should be"), gender_view_dict),

                "1_shot_first_person_backstory" : (lambda row: (f"{make_backstory1_shot()} I think sandwiches are good.\n\n"
                                                                f"{make_backstory1(row)} Regarding legal recognition, I think gay couple relationships should be"), gender_view_dict),
