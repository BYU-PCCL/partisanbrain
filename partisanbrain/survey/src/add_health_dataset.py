...
class AddHealthDataset(Dataset):
    ...
    def _make_backstory(self, row):
        ...
        if "Non" in religion:
            backstory.append(("I do not identify with any religion in particular."))
        else:
        ...
        return {
                ...
                "prayer_in_private": PromptSpecs(
                    ...
                    answer_map={"(0) Never": "never pray",
                                ...
                                "(4) Once a week": "frequently pray",
                                "(5) A few times a week": "frequently pray",
                                "(6) Once a day": "frequently pray",
                                "(7) More than once a day": "frequently pray"})
        }                
